...
Co.constants = {
  ...
  colors: ['red', 'orange', 'yellow', 'green', 'forest', 'blue', 'midnight', 'purple'],

  fbDefaultPermissions: ['public_profile','email', 'user_friends'],

  semesters: ['20151', '20143'],
  ...
  semesterDates: {
    ...
    20151: {
      start: moment('01/20/2015', 'MM-DD-YYYY'),
      end: moment('05/15/2015', 'MM-DD-YYYY')
    }
  }
};
